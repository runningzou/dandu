...
import com.runningzou.dandu.databinding.FragmentLeftMenuBinding;
...
public class LeftMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewList.add(mBinding.homePageTv);
        mViewList.add(mBinding.wordsTv);
        mViewList.add(mBinding.voiceTv);
        mViewList.add(mBinding.videoTv);
        mViewList.add(mBinding.calendarTv);
