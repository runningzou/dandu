...
import com.runningzou.dandu.util.DimenUtils;
...
public abstract class BaseDialog extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NO_TITLE, R.style.AppTheme_Widget_BaseDialog);
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = DimenUtils.getScreenWidth() - 2 * DimenUtils.dp2px(margin);
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = DimenUtils.dp2px(width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = DimenUtils.dp2px(height);
            }
